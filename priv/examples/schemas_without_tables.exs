...
params = %{name1: "John", name2: "Cougar", name3: "Mellencamp", birth_date: ~D[1951-10-07]}
...
assert %Artist{name: "John Cougar Mellencamp"} =
         Repo.get_by(Artist, name: "John Cougar Mellencamp")
