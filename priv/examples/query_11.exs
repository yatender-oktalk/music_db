...
assert MapSet.new(["Cookin' At The Plugged Nickel", "Kind Of Blue"]) ==
         MapSet.new(Repo.all(album_query))
...
track_query =
  from(a in albums_by_miles, join: t in "tracks", on: a.id == t.album_id, select: t.title)
